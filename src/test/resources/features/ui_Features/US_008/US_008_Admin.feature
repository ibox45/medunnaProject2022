@AdminPassword
Feature: Admin giriş yaptığında Password sekmesi düzenlenebilir olmalıdır

  Scenario Outline: Admin rolüyle şifre değiştirebilmelidir (Pozitif Seneryo)
    ...
    Examples:
      ...
      | admin_team57 | ortakKullan.2022 | güneşSen  |


  Scenario: Admin rolüyle şifre değiştirebilmelidir (Negatif Seneryo)
  ...
  Scenario Outline: Admin rolüyle Şifreye 1 küçük harf ekleyerek Password strength seviyesinin değiştiği doğrulanmalıdır
  ...
  Scenario Outline: Admin rolüyle Şifreye 1 büyük harf ekleyerek Password strength seviyesinin değiştiği doğrulanmalıdır
    Given New password textboxını temizler
    When New password textbaxına "<password>" sifresini gönderir
    And  Password strength' in bir diş olduğunu doğrular
    And New password textbaxına "<add_character>" ekler
  ...
  Scenario Outline: Admin rolüyle Şifreye 1 rakam ekleyerek Password strength seviyesinin değiştiği doğrulanmalıdır
    Given New password textboxını temizler
    When New password textbaxına "<password>" sifresini gönderir
    And  Password strength' in iki diş olduğunu doğrular
    And New password textbaxına "<add_character>" ekler
  ...
  Scenario Outline: Admin rolüyle Şifreye 1 özel karakter ekleyerek Password strength seviyesinin değiştiği doğrulanmalıdır
    Given New password textboxını temizler
    When New password textbaxına "<password>" sifresini gönderir
    And  Password strength' in dört diş olduğunu doğrular
    And New password textbaxına "<add_character>" ekler
  ...
  Scenario Outline: Admin 10 adet türkçe'ye özgü karakter girdiğinde Password strength seviyesinin değiştiğini doğrular
    Given New password textboxını temizler
    When New password textbaxına "<password>" sifresini gönderir
    And  Password strength' in bir diş olduğunu doğrular
    Given New password textboxını temizler
  ...
  Scenario Outline: Admin olarak Password strength seviyesinin değişmesi için en az 7 karakter kullanılmalıdır (Negatif Senaryo)
    Given New password textboxını temizler
    When New password textbaxına "<password>" sifresini gönderir
    And  Password strength' in bir diş olduğunu doğrular
    Examples:
  ...
  Scenario Outline: Admin olarak Password strength seviyesinin değişmesi için en az 7 karakter kullanılmalıdır (Pozitif Senaryo)
    Given New password textboxını temizler
    When New password textbaxına "<password>" sifresini gönderir
    And  Password strength' in bir diş olduğunu doğrular
    And New password textbaxına "<add_character>" ekler
  ...
  Scenario Outline: Admin olarak Eski şifre yeni şifre olarak kayıt edilememelidir
  ...
  Scenario Outline: Admin olarak kodun yeniden calisirken hata vermemesi icin sifreyi degistirme
    Given New password textboxını temizler
    Given New password confirmation textboxını temizler
